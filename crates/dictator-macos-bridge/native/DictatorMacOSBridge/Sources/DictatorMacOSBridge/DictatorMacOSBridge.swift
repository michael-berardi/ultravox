/*
 *  DictatorMacOSBridge.swift
 *  Minimal macOS-native bridge callable from Rust.
 *
 *  This file exposes @_cdecl functions for Rust/Tauri Dictator parity.
 *  The native baseline is the Dictator Swift codebase; these
...
private enum MeetingCaptureError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .noDisplay:
            return "Dictator could not find a display to capture."
        case .alreadyRecording:
        ...
        case .exportUnavailable:
            return "Dictator could not prepare the meeting audio track."
        case let .exportFailed(details):
            return "Dictator could not extract meeting audio: \(details)"
        }
    }
}
...
private final class MeetingCaptureManager: NSObject, SCRecordingOutputDelegate, @unchecked Sendable {
    ...
    private func exportAudio(from videoURL: URL) async throws -> URL {
        ...
        print("[DictatorMacOSBridge] exporting \(sourceTracks.count) captured audio track(s)")
...
@_cdecl("dictator_macos_bridge_version")
public func dictator_macos_bridge_version() -> UnsafeMutablePointer<CChar> {
    "DictatorMacOSBridge 0.2.0-native-parity".duplicateAsCChar()
}

/// Frees a string previously returned by this bridge.
@_cdecl("dictator_macos_bridge_free_string")
public func dictator_macos_bridge_free_string(_ s: UnsafeMutablePointer<CChar>?) {
    if let s = s {
        free(s)
    }
}
...
@_cdecl("dictator_macos_bridge_microphone_authorization_status")
public func dictator_macos_bridge_microphone_authorization_status() -> Int32 {
...
@_cdecl("dictator_macos_bridge_request_microphone_access")
public func dictator_macos_bridge_request_microphone_access() -> Int32 {
...
@_cdecl("dictator_macos_bridge_start_meeting_capture")
public func dictator_macos_bridge_start_meeting_capture(
...
@_cdecl("dictator_macos_bridge_stop_meeting_capture")
public func dictator_macos_bridge_stop_meeting_capture(
...
@_cdecl("dictator_macos_bridge_set_meeting_capture_failure_callback")
public func dictator_macos_bridge_set_meeting_capture_failure_callback(
    _ callback: (@convention(c) (UnsafePointer<CChar>?) -> Void)?
) {
...
/// Returns whether Dictator can inspect and edit the focused accessibility element.
/// Passing a non-zero prompt value asks macOS to show its permission prompt.
@_cdecl("dictator_macos_bridge_is_accessibility_trusted")
public func dictator_macos_bridge_is_accessibility_trusted(_ prompt: Int32) -> Int32 {
...
@_cdecl("dictator_macos_bridge_get_caret_position")
public func dictator_macos_bridge_get_caret_position(
...
@_cdecl("dictator_macos_bridge_capture_insertion_target")
public func dictator_macos_bridge_capture_insertion_target(
    _ xOut: UnsafeMutablePointer<Double>?,
    _ yOut: UnsafeMutablePointer<Double>?
) -> Int32 {
...
@_cdecl("dictator_macos_bridge_clear_insertion_target")
public func dictator_macos_bridge_clear_insertion_target() {
    runOnMainActor {
...
@_cdecl("dictator_macos_bridge_paste_text")
public func dictator_macos_bridge_paste_text(_ text: UnsafePointer<CChar>?) -> Int32 {
...
@_cdecl("dictator_macos_bridge_start_modifier_hotkey")
public func dictator_macos_bridge_start_modifier_hotkey(_ modifier: UnsafePointer<CChar>?) -> Int32 {
...
@_cdecl("dictator_macos_bridge_stop_modifier_hotkey")
public func dictator_macos_bridge_stop_modifier_hotkey() -> Int32 {
    runOnMainActor {
...
/// through the callback registered with `dictator_macos_bridge_set_key_combination_callback`.
@_cdecl("dictator_macos_bridge_start_key_combination_hotkey")
public func dictator_macos_bridge_start_key_combination_hotkey(
...
@_cdecl("dictator_macos_bridge_stop_key_combination_hotkey")
public func dictator_macos_bridge_stop_key_combination_hotkey() -> Int32 {
    runOnMainActor {
...
@_cdecl("dictator_macos_bridge_set_key_combination_callback")
public func dictator_macos_bridge_set_key_combination_callback(
...
@_cdecl("dictator_macos_bridge_start_meeting_hotkey")
public func dictator_macos_bridge_start_meeting_hotkey(
    _ combo: UnsafePointer<CChar>?
) -> Int32 {
...
@_cdecl("dictator_macos_bridge_stop_meeting_hotkey")
public func dictator_macos_bridge_stop_meeting_hotkey() -> Int32 {
    runOnMainActor {
...
@_cdecl("dictator_macos_bridge_set_meeting_hotkey_callback")
public func dictator_macos_bridge_set_meeting_hotkey_callback(
    _ callback: (@convention(c) (Int32, UnsafePointer<CChar>?) -> Void)?
) {
...
/// recording indicator.
@_cdecl("dictator_macos_bridge_show_indicator")
public func dictator_macos_bridge_show_indicator(x: Double, y: Double) -> Int32 {
    runOnMainActor {
...
@_cdecl("dictator_macos_bridge_set_indicator_state")
public func dictator_macos_bridge_set_indicator_state(_ state: UnsafePointer<CChar>?) -> Int32 {
...
@_cdecl("dictator_macos_bridge_hide_indicator")
public func dictator_macos_bridge_hide_indicator() -> Int32 {
    runOnMainActor {
...
/// Defaults to the English v2 model to match the Dictator app default.
@_cdecl("dictator_macos_bridge_transcribe_file")
public func dictator_macos_bridge_transcribe_file(
    _ path: UnsafePointer<CChar>?,
    _ textOut: UnsafeMutablePointer<UnsafeMutablePointer<CChar>?>?
) -> Int32 {
    return dictator_macos_bridge_transcribe_file_with_version(path, "v2", nil, nil, textOut)
}
...
@_cdecl("dictator_macos_bridge_transcribe_file_with_version")
public func dictator_macos_bridge_transcribe_file_with_version(
    _ path: UnsafePointer<CChar>?,
    ...
    do {
        ...
        print("[DictatorMacOSBridge] transcription failed: \(error)")
        textOut?.pointee = nil
        return 0
    }
#else
    print("[DictatorMacOSBridge] FluidAudio not available on this platform")
    textOut?.pointee = nil
    return 0
#endif
}
...
@_cdecl("dictator_macos_bridge_cancel_transcription")
public func dictator_macos_bridge_cancel_transcription(
    _ recordingId: UnsafePointer<CChar>?
) -> Int32 {
    let recordingIdString = recordingId.map { String(cString: $0) } ?? ""
    ...
    do {
        ...
        print("[DictatorMacOSBridge] cancel_transcription failed: \(error)")
        return 0
    }
#else
    return 0
...
@_cdecl("dictator_macos_bridge_prepare_model")
public func dictator_macos_bridge_prepare_model(
    _ version: UnsafePointer<CChar>?,
    _ directory: UnsafePointer<CChar>?
) -> Int32 {
    let versionString = version.map { String(cString: $0) } ?? "v2"
    ...
    do {
        ...
        print("[DictatorMacOSBridge] prepare_model failed: \(error)")
        return 0
    }
#else
    print("[DictatorMacOSBridge] FluidAudio not available on this platform")
...
@_cdecl("dictator_macos_bridge_is_model_downloaded")
public func dictator_macos_bridge_is_model_downloaded(
    _ version: UnsafePointer<CChar>?,
    _ directory: UnsafePointer<CChar>?
) -> Int32 {
    let versionString = version.map { String(cString: $0) } ?? "v2"
...
@_cdecl("dictator_macos_bridge_get_model_progress")
public func dictator_macos_bridge_get_model_progress(
    _ version: UnsafePointer<CChar>?
) -> Double {
    let versionString = version.map { String(cString: $0) } ?? "v2"
...
private final class ModifierOnlyMonitor: @unchecked Sendable {
    ...
    func start(modifier rawValue: String) -> Bool {
        ...
        print("[DictatorMacOSBridge] monitoring modifier \(rawValue)")
        return true
    }
...
private final class KeyCombinationMonitor: @unchecked Sendable {
    ...
    func start(combo: String, holdToRecord: Bool) -> Bool {
        ...
        guard let parsed = KeyCombination.parse(combo) else {
            print("[DictatorMacOSBridge] unable to parse key combination: \(combo)")
            return false
        }
        ...
        guard installStatus == noErr else {
            self.combo = nil
            print("[DictatorMacOSBridge] failed to install key combination handler: \(installStatus)")
            return false
        }
        ...
        guard registerStatus == noErr else {
            ...
            self.combo = nil
            print("[DictatorMacOSBridge] failed to register key combination: \(registerStatus)")
            return false
        }

        print("[DictatorMacOSBridge] monitoring \(combo)")
        return true
    }
    ...
    func stop() {
        ...
        combo = nil
        isKeyDown = false
        print("[DictatorMacOSBridge] stopped key combination monitor")
    }
