    ...
    var body: some View {
        ...
        .safeAreaInset(edge: .bottom) {
            HStack {
                ...
                Link(destination: URL(string: "https://github.com/michael-berardi/ultravox")!) {
                    HStack(spacing: 4) {
        ...
        Form {
            Section {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    Picker("Model", selection: $viewModel.fluidAudioModelVersion) {
                        Text("English").tag("v2")
