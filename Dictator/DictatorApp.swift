...
class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        DictatorApp.startTranscriptionQueue()
    ...
    private func setupStatusBarItem() {
        ...
        if let button = statusItem?.button {
            if let iconImage = NSImage(named: "tray_icon") {
                ...
                button.image = NSImage(systemSymbolName: "waveform", accessibilityDescription: "Dictator")
            }
    ...
    private func updateStatusBarMenu() {
        ...
        menu.addItem(NSMenuItem(title: "Dictator", action: #selector(openApp), keyEquivalent: "o"))
    ...
    func showMainWindow() {
        ...
        if let window = mainWindow {
            ...
            let url = URL(string: "dictator://openMainWindow")!
